        ...
        <div class="row">
            <div class="col-md-6">
                  <label  for="">Password</label>
                   ...
                   placeholder="Enter Doctor's Paasword" autocomplete="off">
                    ...
                    <label for="">Gender</label>
                        <select name="gender" class="form-control border-primary 
                         ...
                         <option value="{{$gender}}"
                          @if($user->gender==$gender) selected
                          @endif>{{$gender}}</option>     
                ...
                <div class="col-md-6">
                    <label  for="">Specialist</label>
                     ...
                     {{--    <option value=""> Please select</option>
                        ...
                        @foreach ( ['Cardiologist' ,'Medicine', 'Gynaecologist' , 'Urologist','Chest-Disease' ,'Dermatologist', 'Gastroenterologist'] as $department)

                         <option value="{{$department}}"
                          @if($user->department==$department) selected
